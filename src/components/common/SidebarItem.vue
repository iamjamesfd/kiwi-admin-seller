...
<template>
    <RouterLink
      ...
      class="flex relative items-center gap-3 text-[#9B9B9B] py-4 pl-[60px] text-[15px] hover:bg-[#1E1E23] border-l-[5px] border-transparent h-[54px]"
      :class="{ '!px-0 justify-center': props.collapsed }"
    > 
      <Icon
        :icon="props.icon"
        class="absolute left-5 w-[24px] h-[24px] transition-all duration-500 delay-[100ms]"
      ></Icon>
