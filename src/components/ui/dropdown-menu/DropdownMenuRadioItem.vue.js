...
function __VLS_template() {
    ...
    // @ts-ignore
    var __VLS_13 = __VLS_asFunctionalComponent(__VLS_12, new __VLS_12(__assign({ class: ("h-2 w-2 fill-current") })));
    var __VLS_14 = __VLS_13.apply(void 0, __spreadArray([__assign({ class: ("h-2 w-2 fill-current") })], __VLS_functionalComponentArgsRest(__VLS_13), false));
    ({}(__assign({ class: ("h-2 w-2 fill-current") })));
    // @ts-ignore
