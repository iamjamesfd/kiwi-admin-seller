...
function __VLS_template() {
    ...
    __VLS_components.DropdownMenuLabel;
    // @ts-ignore
    [radix_vue_1.DropdownMenuLabel, radix_vue_1.DropdownMenuLabel,];
    // @ts-ignore
    var __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0(__assign(__assign({}, (__VLS_ctx.forwardedProps)), { class: ((__VLS_ctx.cn('px-2 py-1.5 text-sm font-semibold', __VLS_ctx.inset && 'pl-8', props.class))) })));
    var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign(__assign({}, (__VLS_ctx.forwardedProps)), { class: ((__VLS_ctx.cn('px-2 py-1.5 text-sm font-semibold', __VLS_ctx.inset && 'pl-8', props.class))) })], __VLS_functionalComponentArgsRest(__VLS_1), false));
    ({}(__assign(__assign({}, (__VLS_ctx.forwardedProps)), { class: ((__VLS_ctx.cn('px-2 py-1.5 text-sm font-semibold', __VLS_ctx.inset && 'pl-8', props.class))) })));
    __VLS_styleScopedClasses = ((0, utils_1.cn)('px-2 py-1.5 text-sm font-semibold', inset && 'pl-8', props.class));
    var __VLS_6 = {};
    // @ts-ignore
    [forwardedProps, utils_1.cn, inset,];
    ...
    var __VLS_internalComponent = __VLS_defineComponent({
        setup: function () {
            return {
                DropdownMenuLabel: radix_vue_1.DropdownMenuLabel,
                cn: utils_1.cn,
