...
function __VLS_template() {
    ...
    ({}.DropdownMenuRadioGroup);
    ({}.DropdownMenuRadioGroup);
    __VLS_components.DropdownMenuRadioGroup;
    __VLS_components.DropdownMenuRadioGroup;
    // @ts-ignore
    [radix_vue_1.DropdownMenuRadioGroup, radix_vue_1.DropdownMenuRadioGroup,];
    // @ts-ignore
    ...
    var __VLS_internalComponent = __VLS_defineComponent({
        setup: function () {
            return {
                DropdownMenuRadioGroup: radix_vue_1.DropdownMenuRadioGroup,
                forwarded: forwarded,
            };
        },
        props: {},
