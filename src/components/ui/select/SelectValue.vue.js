...
function __VLS_template() {
    ...
    ({}.SelectValue);
    ({}.SelectValue);
    __VLS_components.SelectValue;
    __VLS_components.SelectValue;
    // @ts-ignore
    [radix_vue_1.SelectValue, radix_vue_1.SelectValue,];
    // @ts-ignore
    var __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0(__assign({}, (props))));
    var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign({}, (props))], __VLS_functionalComponentArgsRest(__VLS_1), false));
    ({}(__assign({}, (props))));
    var __VLS_6 = {};
    ...
    var __VLS_internalComponent = __VLS_defineComponent({
        setup: function () {
            return {
                SelectValue: radix_vue_1.SelectValue,
            };
        },
        props: {},
    });
