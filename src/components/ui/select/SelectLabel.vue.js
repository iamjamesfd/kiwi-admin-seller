...
function __VLS_template() {
    ...
    ({}.SelectLabel);
    ({}.SelectLabel);
    __VLS_components.SelectLabel;
    __VLS_components.SelectLabel;
    // @ts-ignore
    [radix_vue_1.SelectLabel, radix_vue_1.SelectLabel,];
    // @ts-ignore
    var __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0(__assign({ class: ((__VLS_ctx.cn('py-1.5 pl-8 pr-2 text-sm font-semibold', props.class))) })));
    var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign({ class: ((__VLS_ctx.cn('py-1.5 pl-8 pr-2 text-sm font-semibold', props.class))) })], __VLS_functionalComponentArgsRest(__VLS_1), false));
    ({}(__assign({ class: ((__VLS_ctx.cn('py-1.5 pl-8 pr-2 text-sm font-semibold', props.class))) })));
    __VLS_styleScopedClasses = ((0, utils_1.cn)('py-1.5 pl-8 pr-2 text-sm font-semibold', props.class));
    var __VLS_6 = {};
    // @ts-ignore
    [utils_1.cn,];
    ...
    var __VLS_internalComponent = __VLS_defineComponent({
        setup: function () {
            return {
                SelectLabel: radix_vue_1.SelectLabel,
                cn: utils_1.cn,
            };
        },
        props: {},
