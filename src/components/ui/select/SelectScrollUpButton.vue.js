...
function __VLS_template() {
    ...
    __VLS_components.SelectScrollUpButton;
    // @ts-ignore
    [radix_vue_1.SelectScrollUpButton, radix_vue_1.SelectScrollUpButton,];
    // @ts-ignore
    ...
    var __VLS_7 = {}
        .ChevronUp;
    ({}.ChevronUp);
    __VLS_components.ChevronUp;
    // @ts-ignore
    [lucide_vue_next_1.ChevronUp,];
    // @ts-ignore
    ...
    var __VLS_internalComponent = __VLS_defineComponent({
        setup: function () {
            return {
                SelectScrollUpButton: radix_vue_1.SelectScrollUpButton,
                ChevronUp: lucide_vue_next_1.ChevronUp,
                cn: utils_1.cn,
