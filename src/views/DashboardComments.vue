...
<template>
  ...
  <div class="grid grid-cols-12 gap-3 px-8 py-6">
    <div class="bg-white rounded-xl col-span-8">
    ...
    <div class="bg-white rounded-lg col-span-12 md:col-span-4 p-5" v-if="selectedItem">
      ...
      <div
        class="mt-4 w-[315px] h-[177px] bg-white border transition-colors border-stroke_primary rounded-xl p-4 flex flex-col justify-between has-[:focus]:border-gray-300"
      >
        <textarea
          class="placeholder:text-gray-500 text-sm focus:outline-none resize-none"
