...
function __VLS_template() {
    ...
    // @ts-ignore
    var __VLS_0 = __VLS_asFunctionalComponent(DashboardHeader_vue_1.default, new DashboardHeader_vue_1.default({ title: ("User"), }));
    var __VLS_1 = __VLS_0.apply(void 0, __spreadArray([{ title: ("User"), }], __VLS_functionalComponentArgsRest(__VLS_0), false));
    ({}({ title: ("User"), }));
