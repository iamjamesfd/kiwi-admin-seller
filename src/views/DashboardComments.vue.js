...
function __VLS_template() {
    ...
    // @ts-ignore
    var __VLS_0 = __VLS_asFunctionalComponent(DashboardHeader_vue_1.default, new DashboardHeader_vue_1.default({ title: ("Sharhlar"), }));
    var __VLS_1 = __VLS_0.apply(void 0, __spreadArray([{ title: ("Sharhlar"), }], __VLS_functionalComponentArgsRest(__VLS_0), false));
    ({}({ title: ("Sharhlar"), }));
