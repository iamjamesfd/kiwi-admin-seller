...
function __VLS_template() {
  ...
  const __VLS_0 = __VLS_asFunctionalComponent(
    DashboardHeader,
    new DashboardHeader({ title: 'Mahsulot yaratish' })
  )
  ...
  __VLS_elementAsFunction(
    ...
    __VLS_intrinsicElements.div
  )({ ...{ class: 'grid grid-cols-12 gap-6 p-5 text-black' } })
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.div,
    __VLS_intrinsicElements.div
  )({ ...{ class: 'col-span-12 min-[750px]:col-span-10 lg:col-span-8 rounded-lg bg-white p-7' } })
  __VLS_elementAsFunction(
  ...
  const __VLS_6 = __VLS_asFunctionalComponent(
    __VLS_5,
    new __VLS_5({ modelValue: __VLS_ctx.editorContent, options: __VLS_ctx.editorOptions })
  )
  ...
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.div,
    __VLS_intrinsicElements.div
  )({ ...{ class: 'col-span-12 min-[750px]:col-span-10 lg:col-span-8 p-7 bg-white rounded-lg' } })
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.h3,
    __VLS_intrinsicElements.h3
  )({ ...{ class: 'mb-2' } })
  ...
  __VLS_elementAsFunction(
    ...
    __VLS_intrinsicElements.p
  )({ ...{ class: 'text-[#3A93FF] text-[12px] font-light mb-6' } })
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.div,
    __VLS_intrinsicElements.div
  ...
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.div,
    __VLS_intrinsicElements.div
  )({ ...{ class: 'rounded-lg border-[2px] border-dashed text-[#7F7F7F]' } })
  __VLS_elementAsFunction(__VLS_intrinsicElements.input)({
    type: 'file',
    ...{ class: 'hidden' },
    id: 'image'
  ...
  __VLS_elementAsFunction(
    ...
    __VLS_intrinsicElements.label
  )({ for: 'image', ...{ class: 'h-[100px] w-[90px] flex flex-col justify-center items-center' } })
  // @ts-ignore
  const __VLS_11 = {}.Icon
  ;({}).Icon
  ;({}).Icon
  ...
  const __VLS_12 = __VLS_asFunctionalComponent(
    __VLS_11,
    new __VLS_11({ icon: 'akar-icons:cloud-upload', ...{ class: 'w-6 h-6' } })
  )
  ...
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.p,
    __VLS_intrinsicElements.p
  )({ ...{ class: 'text-[12px] text-[#7F7F7F] text-center' } })
  for (const [x] of __VLS_getVForSourceType(9)) {
    __VLS_elementAsFunction(
      __VLS_intrinsicElements.div,
      __VLS_intrinsicElements.div
    )({ ...{ class: 'rounded-lg border-[2px] border-dashed text-[#7F7F7F]' }, key: x })
    __VLS_elementAsFunction(__VLS_intrinsicElements.input)({
      type: 'file',
      ...{ class: 'hidden' },
      id: 'image_' + x
    ...
    const __VLS_18 = __VLS_asFunctionalComponent(
      __VLS_17,
      new __VLS_17({ icon: 'ph:plus-bold', ...{ class: 'w-6 h-6' } })
    )
  ...
  __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({})
  {
    ...
    __VLS_elementAsFunction(
      __VLS_intrinsicElements.div,
      __VLS_intrinsicElements.div
    )({ ...{ class: 'px-3 py-3 hover:bg-slate-100 hover:text-[#FF6200] flex items-center gap-4' } })
  ...
  if (__VLS_ctx.isDeliveryAvalible) {
    ...
    __VLS_elementAsFunction(
      __VLS_intrinsicElements.div,
      __VLS_intrinsicElements.div
    )({ ...{ class: 'flex gap-4 min-[550px]:relative min-[550px]:top-9' } })
    __VLS_elementAsFunction(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({})
    __VLS_elementAsFunction(
      __VLS_intrinsicElements.label,
      __VLS_intrinsicElements.label
  ...
  __VLS_elementAsFunction(
    ...
    ...{ onClick: __VLS_ctx.addVariant },
    ...{ class: 'flex items-center text-[#2563EB] gap-3 cursor-default' }
  })
  // @ts-ignore
  const __VLS_28 = {}.Icon
  ;({}).Icon
  ...
  __VLS_elementAsFunction(
    ...
    ...{
      class:
        'col-span-12 min-[750px]:col-span-10 lg:col-span-8 p-7 bg-white rounded-lg flex gap-4 flex-wrap'
    }
  })
  __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({})
  __VLS_elementAsFunction(
  ...
  const __VLS_34 = __VLS_asFunctionalComponent(
    VueSelect,
    new VueSelect({ options: ['UZS', 'USD'], default: 'USD', optionType: 'String' })
  )
  ...
  __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({})
  {
    ...
    const __VLS_40 = __VLS_asFunctionalComponent(
      __VLS_39,
      new __VLS_39({ icon: 'emojione:green-apple' })
    )
  ...
  __VLS_elementAsFunction(
    ...
    ...{
      class:
        'col-span-12 min-[750px]:col-span-10 lg:col-span-8 flex items-center flex-wrap min-[430px]:justify-end gap-6'
    }
  })
  ...
  __VLS_elementAsFunction(
    ...
    __VLS_intrinsicElements.button
  )({ ...{ class: 'bg-white py-[10px] px-[32px] rounded-lg' } })
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.button,
    __VLS_intrinsicElements.button
