...
function __VLS_template() {
  ...
  const __VLS_0 = __VLS_asFunctionalComponent(
    DashboardHeader,
    new DashboardHeader({ title: 'Reklama qilish' })
  )
  const __VLS_1 = __VLS_0(
    { title: 'Reklama qilish' },
  ...
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.div,
    __VLS_intrinsicElements.div
  )({ ...{ class: 'relative bg-white p-5 rounded-lg flex flex-col items-start' } })
  __VLS_elementAsFunction(
  ...
  const __VLS_6 = __VLS_asFunctionalComponent(
    __VLS_5,
    new __VLS_5({ icon: 'simple-line-icons:check', ...{ class: 'text-[#0EB182]' } })
  )
  const __VLS_7 = __VLS_6(
    { icon: 'simple-line-icons:check', ...{ class: 'text-[#0EB182]' } },
  ...
  __VLS_elementAsFunction(
    ...
    ...{
      class: 'absolute bottom-5 bg-[#0EB182] text-white py-[10px] px-[32px] rounded-lg justify-end'
    }
  })
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.div,
  ...
  const __VLS_12 = __VLS_asFunctionalComponent(
    __VLS_11,
    new __VLS_11({ icon: 'simple-line-icons:check', ...{ class: 'text-[#0EB182]' } })
  )
  ...
  const __VLS_18 = __VLS_asFunctionalComponent(
    __VLS_17,
    new __VLS_17({ icon: 'simple-line-icons:check', ...{ class: 'text-[#0EB182]' } })
  )
  ...
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.div,
    __VLS_intrinsicElements.div
  )({ ...{ class: 'bg-white p-5 rounded-lg flex flex-col items-start' } })
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.p,
    __VLS_intrinsicElements.p
  )({ ...{ class: 'text-[#FF6200]' } })
  ...
  const __VLS_24 = __VLS_asFunctionalComponent(
    __VLS_23,
    new __VLS_23({ icon: 'simple-line-icons:check', ...{ class: 'text-[#0EB182]' } })
  )
  ...
  const __VLS_30 = __VLS_asFunctionalComponent(
    __VLS_29,
    new __VLS_29({ icon: 'simple-line-icons:check', ...{ class: 'text-[#0EB182]' } })
  )
  ...
  const __VLS_36 = __VLS_asFunctionalComponent(
    __VLS_35,
    new __VLS_35({ icon: 'simple-line-icons:check', ...{ class: 'text-[#0EB182]' } })
  )
  ...
  __VLS_elementAsFunction(
    ...
    ...{ class: 'bg-[#0EB182] mt-8 text-white py-[10px] px-[32px] rounded-lg justify-self-end' }
  })
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.h1,
    __VLS_intrinsicElements.h1
  )({ ...{ class: 'text-2xl font-semibold mt-10 mb-5' } })
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.div,
    __VLS_intrinsicElements.div
  )({ ...{ class: 'grid grid-cols-3 gap-6' } })
  ...
  const __VLS_42 = __VLS_asFunctionalComponent(
    __VLS_41,
    new __VLS_41({ icon: 'simple-line-icons:check', ...{ class: 'text-[#0EB182]' } })
  )
  ...
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.button,
    __VLS_intrinsicElements.button
  )({ ...{ class: 'mt-8 bg-[#0EB182] text-white py-[10px] px-[32px] rounded-lg justify-end' } })
  __VLS_elementAsFunction(
    __VLS_intrinsicElements.div,
    __VLS_intrinsicElements.div
  )({ ...{ class: 'relative bg-white p-5 rounded-lg flex flex-col items-start' } })
  ...
  const __VLS_48 = __VLS_asFunctionalComponent(
    __VLS_47,
    new __VLS_47({ icon: 'simple-line-icons:check', ...{ class: 'text-[#0EB182]' } })
  )
  ...
  const __VLS_54 = __VLS_asFunctionalComponent(
    __VLS_53,
    new __VLS_53({ icon: 'simple-line-icons:check', ...{ class: 'text-[#0EB182]' } })
  )
  ...
  if (typeof __VLS_styleScopedClasses === 'object' && !Array.isArray(__VLS_styleScopedClasses)) {
    ...
    __VLS_styleScopedClasses['text-[#0EB182]']
    ...
    __VLS_styleScopedClasses['px-[32px]']
    __VLS_styleScopedClasses['rounded-lg']
    __VLS_styleScopedClasses['justify-self-end']
    __VLS_styleScopedClasses['text-2xl']
    __VLS_styleScopedClasses['font-semibold']
